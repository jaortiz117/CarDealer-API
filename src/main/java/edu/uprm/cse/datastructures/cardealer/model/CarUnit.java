...
public class CarUnit {
	...
	public CarUnit(long carUnitId, long carId, String vin, String color) {
		this(carUnitId, carId, vin, color, null, -1);
	}
	
	public void purchase(String carPlate, long personId) {
